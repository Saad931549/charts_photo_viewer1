...
<?php
      ...
      $data = file_get_contents('public_html/NestData/JSON_00000000_00214.JSON');
      $schema =
      '[{
            "name": "Time",
            "type": "date",
...
<div class="nestImageDiv">
	<img src="public_html/NestImgs/placeholder.jpg" alt="" id="nestImg">
...
function showNestImg(dt) {
	var pthPrefix = 'public_html/NestImgs/';
	if(dt == '') {
		return false;
	}
